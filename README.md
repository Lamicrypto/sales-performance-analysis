...
Businesses often generate large amounts of sales data but may struggle to identify which products, customers, locations, and strategies are driving sustainable profitability.

This project analyzes Superstore sales data to understand:

* What products and categories generate the most sales and profit.
* Which products and locations are underperforming.
* How discount levels relate to profitability.
* Which customer segments generate the strongest performance.
* How shipping methods affect sales and profitability.
...
* Evaluate sales and profitability across regions, cities, and states.
...
Sales and profit were analyzed across the three major product categories:
...
Furniture had the highest average discount and the lowest average profit.
...
Discount policies should consider:
...
Business performance should be evaluated using a combination of:
